...
<table width="80%" cellpadding="10" class="tableS" cellspacing="10" style="font-family: Times New Roman; font-size: 11.5px !important;margin-left:20px" >
 <tr>
    <td colspan="2" style="text-align:center" class="noborder"><img src="{{url('assets/img/logo.png')}}" width="220" alt="PRA"></td>
...
<table width="80%" cellpadding="10" class="tableS" cellspacing="10" style="font-family: Times New Roman; font-size: 11.5px !important;margin-left:20px;">
 ...
 <tr>
    <td colspan="3" class="noborder"><strong>Date</strong> <?php echo date('d M, Y'); ?>
        
    </td>
     <td colspan="2"  class="noborder" align="right"><strong>Time</strong> <?php echo date('h:i A'); ?> </td>
 </tr>
 <tr>
    <td class="noborder" colspan="5"><strong>Invoice No.</strong> {{ $sale->invoice_no }}</td>
 </tr>
 <tr>
 ...
 <tr>
    ...
    <td id="kitchenph" width="100"><strong>Unit Price</strong></td>
   ...
   <tr height colspan="5" class="tableStyle">
       ...
       <td>
                               <table width="80%" cellpadding="10" class="tableS" cellspacing="10" style="margin-left:20px">
                                <tr>
                      ...
                      <tr>
                            ...
                            <td><strong>{{ $item->product->name }}({{substr($item->size , 0, 1)}})</strong></td>
                            <td class="kitchen" width="100"><strong>{{$item->price}}</strong></td>
                            <td class="kitchen" width="60"><strong>{{ $item->quantity * $item->price }}</strong></td>
                        </tr>
                        <?php $i++;  ?>
                       @endforeach
...
<table style="page-break-inside:avoid;font-family: Times New Roman; font-size: 11.5px !important;margin-left:20px" width="90%" cellpadding="5" class="tableS kitchen" cellspacing="5" id="kitchen">
 ...
 <hr>
  ...
  <tr>
    ...
    <td class="grandtotalFont"><strong>{{$sale->discount}}</strong></td>
 </tr>  
 <tr>
    <td colspan="3"><strong>GRAND TOTAL:</strong></td>
    <td><strong><?php echo $currency; ?></strong></td>
    <td class="grandtotalFont"><strong>{{$sale->subtotal - $sale->discount}}</strong></td>
 </tr>   
 ...
 <tr>
  ...
  <tr>
    ...
    <strong>Thanks for visiting {{setting_by_key('title')}}, {{setting_by_key('address')}}, {{setting_by_key('phone')}}</strong></td>
    
 </tr>  

<tr>
    <td colspan="5" align="center">
    <small><strong>Develop By: abcd 0344-0061122</strong></small></td>
...
<p align="center"><input type="button" id="prK" value="Print Kitchen" onclick="printpageK()" class="btn btn-success" /></p>
